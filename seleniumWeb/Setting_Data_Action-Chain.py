...
def main():
    ...
    # scroll_to_element(action, driver.find_element(By.XPATH, '//*[@id="__next"]/section/div/div[1]/div[1]/div/p'))
    # scroll_by_offset(action, 2000)
    # time.sleep(5)
    # scroll_by_offset(action, -2000)
    # right_click_context(action, driver.find_element(By.XPATH, '//*[@id="__next"]/section/div/div[1]/div[2]/div/div[1]/ul/li[1]/a'))
    # highlight_element1(action, driver.find_element(By.TAG_NAME, 'h2'), 50)
    highlight_element2(action, driver.find_element(By.TAG_NAME, 'h2'), 100)
